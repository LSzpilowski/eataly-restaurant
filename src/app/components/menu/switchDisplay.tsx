...
function SwitchDisplay({isListLayout, setIsListLayout, isGridLayout, setIsGridLayout}) {
  ...
  return (
    <div className="flex flex-row justify-center items-center w-1/5 mr-2">
          <div className="flex flex-row w-16 md:w-24">
                ...
                <TooltipTrigger
                  ...
                  className={`${
                    isListLayout === true
                      ...
                      : "hover:bg-secondary"
                  }  flex flex-row justify-center w-1/2 border-2 border-r-[1px]  rounded-tl-full rounded-bl-full py-1 md:py-2`}
                >
                  <LuMenu />
                </TooltipTrigger>
                ...
                <TooltipTrigger
                  ...
                  className={`${
                    isGridLayout === true
                      ? "bg-orange-700 border-orange-700"
                      : "hover:bg-secondary"
                  } flex flex-row justify-center w-1/2 border-2 border-l-[1px] rounded-tr-full rounded-br-full py-1 md:py-2`}
                >
                  <CiGrid41 />
                </TooltipTrigger>
